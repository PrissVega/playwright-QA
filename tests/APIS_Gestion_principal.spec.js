...
const expectedDataTypesGestionPrincipal = {
  id: 'number',
  instancia_id: 'number',
  empresa_id: 'number',
...
test.describe('API Tests gestion principal', () => { 
  ...
  test('API gestion principal: all', async () => {
    ...
    try {
      ...
      if (responseBody.data && Array.isArray(responseBody.data)) {
        ...
        try {
          ...
          expect(apiTypes).toEqual(expectedDataTypesGestionPrincipal);
  ...
  test('API gestion principal: una', async () => {
